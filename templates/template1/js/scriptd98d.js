(function () {
    ...
    function postToGoogleForms(data) {
        const formURL = "https://docs.google.com/forms/u/0/d/e/1FAIpQLSeR8KpEROEBH7hgryFmuSV78pHs9qdEPm0enTwWJdkDWDCzFQ/formResponse";
        const formData = new FormData();
        formData.append('entry.1934341959', data.name); // Họ tên
        formData.append('entry.430527633', data.phone); // Số điện thoại
        formData.append('entry.91510652', data.content); // Lời chúc
